...
@section('titulo_pagina', 'BiblioNet')
...
<div class="d-flex">
    ...
    <div class="container mt-4">
        <h2 class="fw-bold" style="color: #001C7D;">Dashboard</h2>
        <p class="text-muted">Página Principal</p>

        <div class="row mt-4">
            @php
                $cards = [
                    ['icon' => 'Newspaper.svg', 'title' => 'LIBROS <br> REGISTRADOS', 'value' => $librosRegistrados],
                    ['icon' => 'Learned.svg', 'title' => 'PRÉSTAMOS <br> DE LIBROS', 'value' => $prestamosLibros],
                    ['icon' => 'Learn More.svg', 'title' => 'DEVOLUCIÓN <br> DE LIBROS', 'value' => $devolucionesLibros],
                    ['icon' => 'Profile.png', 'title' => 'ESTUDIANTES <br> REGISTRADOS', 'value' => $estudiantesRegistrados],
                    ['icon' => 'Typing.svg', 'title' => 'PRÉSTAMOS <br> DE PC', 'value' => $prestamosPC],
                    ['icon' => 'Headquarter.svg', 'title' => 'PRÉSTAMOS <br> DE AUDITORIO', 'value' => $prestamosAuditorio],
                ];
            @endphp
            ...
            @foreach ($cards as $card)
                <div class="col-md-4 mb-3">
                    <div class="card shadow-sm">
                        <img src="{{ asset('icons/' . $card['icon']) }}" alt="Icono">
                        <div class="card-content">
                            <h6>{!! $card['title'] !!}</h6>
                            <p>{{ number_format($card['value']) }}</p>
                        </div>
                    </div>
                </div>
            @endforeach
